...
new _slider.Slider(document.querySelector('#sliderRoot'), sliderData);
...
var Slider = exports.Slider = function () {
  function Slider(rootElement, sliderData) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < this.sliderData.length; i++) {
        var _sliderData$i = this.sliderData[i],
            img = _sliderData$i.img,
